...
const Instructors = () => {
  ...
  sx={{
    width: "100%",
    display: "flex",
    flexDirection: { xs: "column", sm: "column", md: "column", lg: "row" }, // Only change here (md: "row")
    justifyContent: "space-between",
    alignItems: { xs: "center", sm: "center", md: "center", lg: "flex-start" }, // Minor adjustment (md: "flex-start")
    mb: 20,
  }}
>
  <Box
  ...
  >
    <Typography variant="h3" sx={{ fontFamily: '"Saira Semi Condensed"', mb: 3, width: "100%" }}>
      Sensei Karim Ebraheem
    </Typography>
    <Typography
      variant="subtitle1"
      sx={{ fontFamily: '"Saira Semi Condensed"', pt: 2, fontSize: 20, width: "100%" }}
    >
     Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
